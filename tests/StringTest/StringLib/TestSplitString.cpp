...
KE_TEST(splitString_pair)
{
	...
	for (char c = '!'; c <= '/'; c++)
	{
		...
		{
			std::pair<std::string, std::string> result_pair = ke::splitString(create_string(c), c, 0);
	...
	p1 = ke::splitString("One;Two;Three;Four;Five", ';', 0);
	...
	p1 = ke::splitString("One;Two;Three;Four;Five", ';', 1);
	p2 = std::pair<std::string, std::string>("One;Two", "Three;Four;Five");
	ASSERT_EQUAL(p1, p2);
	...
	p1 = ke::splitString("One;Two;Three;Four;Five", ';', 2);
	p2 = std::pair<std::string, std::string>("One;Two;Three", "Four;Five");
	ASSERT_EQUAL(p1, p2);
	...
	p1 = ke::splitString("One;Two;Three;Four;Five", ';', 3);
	p2 = std::pair<std::string, std::string>("One;Two;Three;Four", "Five");
	ASSERT_EQUAL(p1, p2);
	...
	p1 = ke::splitString("One;Two;Three;Four;Five", ';', 4);
	p2 = std::pair<std::string, std::string>("One;Two;Three;Four;Five", "");
	ASSERT_EQUAL(p1, p2);
	...
	p1 = ke::splitString("Multichar; split; test", {"; "}, 0);
	...
	p1 = ke::splitString("Multichar; split; test", {"; "}, 1);
	p2 = std::pair<std::string, std::string>("Multichar; split", "test");
	ASSERT_EQUAL(p1, p2);
}
